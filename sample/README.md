...
4. **Report issues** - Found a bug? [Open an issue](https://github.com/nolindnaidoo/colors-le/issues)
...
**Need Help?** Check the [GitHub Issues](https://github.com/nolindnaidoo/colors-le/issues) or open a new issue.
