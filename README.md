...
<p align="center">
  <!-- VS Code Marketplace -->
  <a href="https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.colors-le">
    <img src="https://img.shields.io/visual-studio-marketplace/v/OffensiveEdge.colors-le" alt="VSCode Marketplace Version" />
  </a>
  <!-- Open VSX -->
  <a href="https://open-vsx.org/extension/OffensiveEdge/colors-le">
    <img src="https://img.shields.io/open-vsx/v/OffensiveEdge/colors-le" alt="Open VSX Version" />
  </a>
  <!-- Build -->
  <a href="https://github.com/OffensiveEdge/colors-le/actions">
    <img src="https://img.shields.io/github/actions/workflow/status/OffensiveEdge/colors-le/ci.yml?branch=main" alt="Build Status" />
  </a>
  <!-- License -->
  <a href="https://github.com/OffensiveEdge/colors-le/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/OffensiveEdge/colors-le" alt="MIT License" />
  </a>
</p>
...
- **[URLs-LE](https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.urls-le)** - Extract URLs from web content and APIs • [Open VSX](https://open-vsx.org/extension/OffensiveEdge/urls-le)
...
1. Install from [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.colors-le) or [Open VSX](https://open-vsx.org/extension/OffensiveEdge/colors-le)
